        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div className="group relative p-4 rounded-lg border border-gray-300 dark:border-slate-700 hover:border-indigo-500 transition-all duration-300 bg-white dark:bg-slate-800/50">
                ...
                <div className="text-4xl font-bold bg-gradient-to-r from-indigo-600 via-cyan-600 to-pink-600 dark:from-cyan-400 dark:to-indigo-400 bg-clip-text text-transparent">20+</div>
                <p className="text-gray-600 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">Years Experience</p>
              </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900 border border-gray-200 dark:border-slate-700 rounded-2xl p-8 text-gray-900 dark:text-white">
              <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-indigo-600 to-cyan-600 dark:from-cyan-400 dark:to-indigo-400 bg-clip-text text-transparent">Founder & Director</h3>
              <div className="mb-6">
                ...
                <h4 className="text-xl font-bold text-gray-900 dark:text-white">Mahesh Vaidya</h4>
                <p className="text-cyan-600 dark:text-cyan-400">Founder & Director</p>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-300 dark:border-slate-700">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  <a href="mailto:mahesh.vaidya@awanipro.com" className="text-indigo-600 dark:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-cyan-400 dark:hover:to-indigo-400 dark:hover:bg-clip-text hover:text-indigo-700 transition-all">
                    mahesh.vaidya@awanipro.com
                  </a>
                </p>
                <p className="text-gray-700 dark:text-gray-300 mb-3">Bangalore, India</p>
                <a 
