    ...
    <section className="py-20 sm:py-32 bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-slate-900 dark:to-indigo-900/20">
      <div className="container-max">
        <div className="text-center mb-16 px-4">
          <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-indigo-600 via-cyan-600 to-pink-600 dark:from-cyan-400 dark:via-indigo-400 dark:to-pink-400 bg-clip-text text-transparent mb-4 inline-block">Why Awanipro Digital Technologies?</h2>
